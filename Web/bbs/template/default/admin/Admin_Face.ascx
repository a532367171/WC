...
<div class="BodyBlock PTB5">
	<div class="Block Hidden">
	    ...
	    <ul class="TC Hidden" style="height:60px">
		    ...
		    <li style="width:100px"><a href='Admin_FaceAdd.aspx?ID=<%# Eval("ID") %>'><img src="<%# Eval("FileName") %>" width="50" height="50" /></a></li>
		    <li><%# Eval("FaceName") %></li>
		...
		<div class="Footer PTB5 TC">
			<input type="button" class="Button" value="添加头像" onclick="window.location.href='Admin_FaceAdd.aspx'" />&nbsp;<asp:Button CssClass="Button" ID="DeleteButton" Text="确定删除" OnClientClick="return CheckSelect()" runat="server" />&nbsp;<input type="checkbox" name="All" onclick="SelectAll(this)" />全选/全不选
		</div>
	</div>
