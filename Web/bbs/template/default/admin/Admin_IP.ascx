...
<div class="BodyBlock PTB5">
	<div class="Block Hidden">
		...
		<ul class="Header TC">
			...
			<li class="Left" style="width:120px">IP地址</li>
		...
		<ItemTemplate>
			<ul class="TC">
				...
				<li class="Left" style="width:120px"><a href='Admin_IPAdd.aspx?ID=<%# Eval("ID") %>'><%# Eval("IP") %></a></li>
		...
		<div class="Footer PTB5 TC">
			<input type="button" class="Button" value="添加策略" onclick="window.location.href='Admin_IPAdd.aspx'" />&nbsp;<asp:Button CssClass="Button" ID="DeleteButton" Text="确定删除" OnClientClick="return CheckSelect()" runat="server" />&nbsp;<input type="checkbox" name="All" onclick="SelectAll(this)" />全选/全不选
		</div>
	</div>
