...
BEGIN
    ...
    */
    ...
    INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime,SubType)
	VALUES (100001, N'manager', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'管理员', N'MANAGER', getdate(),0);

	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime,SubType)
	VALUES (100002, N'lilin', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'李林', N'LILIN', getdate(),0);
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime,SubType)
	VALUES (100003, N'yanglei', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'杨磊', N'YANGLEI', getdate(),0);
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime,SubType)
	VALUES (100004, N'maojie', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'毛杰', N'MAOJIE', getdate(),0);
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime,SubType)
	VALUES (100005, N'zhoutao', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'周涛', N'ZHOUTAO', getdate(),0);
...
BEGIN
    ...
    SET IDENTITY_INSERT [UserRelationship] ON
	 ...
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100001 , 100002 , 0 , getdate() , 1 );

	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100002 , 100001 , 0 , getdate() , 2 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100003 , 100002 , 0 , getdate() , 3 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100002 , 100003 , 0 , getdate() , 4 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100004 , 100002 , 0 , getdate() , 5 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100002 , 100004 , 0 , getdate() , 6 );

	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100005 , 100002 , 0 , getdate() , 7 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 100002 , 100005 , 0 , getdate() , 8 );
...
begin	
	...
	insert into UserRelationShip(HostID, GuestID,RelationShip,RenewTime)
	select u1.[ID], u2.[ID], 0, getdate() as RenewTime
	from Users u1, Users u2 
	where u1.UpperName='MANAGER' and u2.[ID]=@id

	insert into UserRelationShip(HostID, GuestID,RelationShip,RenewTime)
	select u2.[ID], u1.[ID], 0, getdate() as RenewTime
	from Users u1, Users u2 
	where u1.UpperName='MANAGER' and u2.[ID]=@id
