...
BEGIN
    ...
    */
    ...
    INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime)
	VALUES (3, N'manager', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'管理员', N'MANAGER', getdate());

	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime)
	VALUES (4, N'lilin', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'李林', N'EE1B4A9D2975472F85C2E0379B6D2427', getdate());
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime)
	VALUES (5, N'yanglei', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'杨磊', N'9BCF20C9A9C842ADA6D24B8E47B427BD', getdate());
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime)
	VALUES (6, N'maojie', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'毛杰', N'1DB199B1A02340F2A93BFD3035072FAD', getdate());
	
	INSERT INTO Users ([ID], [Name], Password, Type, Nickname, UpperName, RegisterTime)
	VALUES (7, N'zhoutao', N'D41D8CD98F00B204E9800998ECF8427E', 0, N'周涛', N'6C19996B2F8949A5A666549BDF67C28D', getdate());
...
BEGIN
	...
	INSERT INTO User_Role([UserID], [RoleID])
	SELECT [Users].[ID], Roles.[ID] FROM [Users], [Roles] WHERE UpperName='MANAGER';
...
BEGIN
    ...
    SET IDENTITY_INSERT [UserRelationship] ON
	 ...
	 VALUES ( 3 , 4 , 0 , getdate() , 1 );

	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 4 , 3 , 0 , getdate() , 2 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 3 , 5 , 0 , getdate() , 3 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 5 , 3 , 0 , getdate() , 4 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 3 , 6 , 0 , getdate() , 5 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 6 , 3 , 0 , getdate() , 6 );

	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 3 , 7 , 0 , getdate() , 7 );
	
	 INSERT INTO [UserRelationship] ([HostID], [GuestID], [Relationship], [RenewTime], [ID])
	 VALUES ( 7 , 3 , 0 , getdate() , 8 );
