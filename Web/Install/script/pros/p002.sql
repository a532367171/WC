...
CREATE PROCEDURE [dbo].[WM_AddUser]

	@name nvarchar(256), 
	@nickname nvarchar(256), 
	@password nvarchar(256),
	@email nvarchar(256), 
	@inviteCode nvarchar(32), 
	@phone nvarchar(256),
	@telphone nvarchar(256)
...
begin
	...
	insert into WM_Users (Name,UpperName,Password,Nickname,Type,EMail,InviteCode,IsTemp,RegisterTime,Phone,TelPhone,IsExitGroup) 
	values (@name,UPPER(@name),@password,@nickname,0,@email,@inviteCode,0,getdate(),@phone,@telphone,0)
