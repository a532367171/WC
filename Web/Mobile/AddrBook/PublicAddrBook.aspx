<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicAddrBook.aspx.cs" Inherits="Mobile_AddrBook_PublicAddrBook" %>
...
<body class="applist">
    ...
    <div class="searchbox">
        ...
        <fieldset>
            <input name="keywords" id="keywords" placeholder="查找(姓名/部门)" type="text" />
        </fieldset>
        </form>
    </div>
    ...
    <div id="content">
        <ul>
            ...
            <span class="image" style="background-image: url('../Style/Mobile/thumbs/contacts.png')"></span>
                ...
                <span class="stars4">
                <%# WC.DK.Help.ValidateMobile(Eval("Phone") + "") ? Eval("Phone")+" (拨号)" : Eval("Phone")%>
                </span>
