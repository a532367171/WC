...
public partial class Mobile_Flows_FlowList : MobilePage

	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			{
				base.Response.Redirect("FlowList.aspx?action=" + base.Request.QueryString["type"] + "&keywords=" + HttpContext.Current.Server.HtmlEncode(base.Request.Form["keywords"]));
			}
