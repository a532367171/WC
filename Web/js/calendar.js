//调用示例：onfocus="javascript:calendar()"
<!--
...
{
    this.regInfo    = "日历关闭快捷键：[Esc]  云创科技 独具匠心!  ";
    ...
    this.darkColor  = "#0099ff";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#EEF6FC";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#B5B5B5";    //控件的暗文字颜色
    this.dayBgColor = "#EEF6FC";    //日期数字背景色
    this.todayColor = "#FF9933";    //今天在日历上的标示背景色
    this.DarkBorder = "#EEF6FC";    //日期显示的立体表达色
}   var WebCalendar = new WebCalendar();

function calendar() //主调函数   调用示例：onfocus="javascript:calendar()"
{
