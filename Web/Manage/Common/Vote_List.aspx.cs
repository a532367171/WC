...
public partial class Manage_Common_Vote_List : ViewPages

	{
		...
		protected void Search_Btn(object sender, EventArgs e)
		{
			...
			base.Response.Redirect("Vote_List.aspx" + str);
		}
		...
		protected void Del_Btn(object obj, EventArgs e)
		{
			...
			if (panel.Visible)
			{
				...
				base.Response.Redirect("Vote_List.aspx");
			}
		}
		...
		private void Show()
		{
			...
			string where = " userlist like '%#" + this.Uid + "#%' or CreateUserID=" + this.Uid;
