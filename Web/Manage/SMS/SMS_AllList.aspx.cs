...
using WC.DBUtility;
using WC.Tool;
public partial class Manage_SMS_AllList : ModulePages

	{
		...
		protected void Search_Btn(object sender, EventArgs e)
		{
			...
			base.Response.Redirect("SMS_AllList.aspx" + str);
		}
		...
		private void Show()
		{
			...
			int num4 = Convert.ToInt32(MsSqlOperate.ExecuteScalar(CommandType.Text, "select count(*) from Sms_Data where " + text, null));
