...
public partial class Manage_gov_gov_ModelList : ModulePages
{
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("Gov_ModelList.aspx" + str);
        }
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            string cmdText = "delete from Gov_Model where id=" + num;
            string cmdText2 = "delete from Gov_ModelStep where Flow_ModelID=" + num;
        ...
        private void Show()
        {
            ...
            IList all = Gov_Model.Init().GetAll(text, "order by id desc");
            int pageSize = 50;
            int num = 0;
            try
            {
