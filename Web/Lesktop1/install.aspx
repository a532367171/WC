	...
	<div class="table_blue">
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbAdminPwd" runat="server">0</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbAdminPwdConfirm" runat="server">0</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
	...
	<div class="table_blue">
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbDbServer" runat="server" 
						TextMode="SingleLine">LINJIE-PC\SQLEXPRESSSB</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbDbName" runat="server" TextMode="SingleLine">lesktop1</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbDbUser" runat="server" TextMode="SingleLine">sa</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				...
				<td class="style2">
					<asp:TextBox class="textbox" ID="tbDbPWD" runat="server">113356965</asp:TextBox>
				</td>
				<td>
					&nbsp;
				</td>
