...
public partial class KindEditor4_upload_json : ViewPages
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            FileSystemManager.CreateFolder(DateTime.Now.ToString("yyMM"), base.Server.MapPath("~/KindEditor4/attached"));
        }
        if (!Directory.Exists(text))
        {
        ...
        KindEditor4_upload_json.FileExtension[] fileEx = new KindEditor4_upload_json.FileExtension[]
			{
				KindEditor4_upload_json.FileExtension.GIF,
				KindEditor4_upload_json.FileExtension.JPG,
				KindEditor4_upload_json.FileExtension.PNG,
				KindEditor4_upload_json.FileExtension.BMP
			};
        if (!KindEditor4_upload_json.IsAllowedExtension(httpPostedFile, fileEx))
        {
    ...
    public static bool IsAllowedExtension(HttpPostedFile fu, KindEditor4_upload_json.FileExtension[] fileEx)
    {
        ...
        {
            KindEditor4_upload_json.FileExtension fileExtension = fileEx[i];
            try
            {
