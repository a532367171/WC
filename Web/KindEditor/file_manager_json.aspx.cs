...
public partial class KindEditor_file_manager_json : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (text6 != null)
        {
            if (text6 == "size")
            {
                Array.Sort(directories, new KindEditor_file_manager_json.NameSorter());
                Array.Sort(files, new KindEditor_file_manager_json.SizeSorter());
                goto IL_243;
            }
            if (text6 == "type")
            {
                Array.Sort(directories, new KindEditor_file_manager_json.NameSorter());
                Array.Sort(files, new KindEditor_file_manager_json.TypeSorter());
                goto IL_243;
            }
            if (!(text6 == "name"))
            {
        ...
        Array.Sort(directories, new KindEditor_file_manager_json.NameSorter());
        Array.Sort(files, new KindEditor_file_manager_json.NameSorter());
    IL_243:
